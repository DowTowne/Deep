...
class Neural:
    ...
    def calculate_error(self,target_out):
        return self.learning_rate  * (target_out - self.out)**2
    ...
    #计算网络计算值z对输入的偏导数
    def calculate_round_net_on_input(self):
        return  self.out * (1 - self.cal_output())

    #计算误差对网络值的偏导
    def calculate_round_error_to_net(self,target_output):
        return  self.calculate_round_error_to_out(target_output) * self.calculate_round_net_on_input();
